...
<!--                        <div class="col-md-15 col-xs-6">-->
            ...
            <?php } ?>
                    ...
                    <?php } ?>
                    <a href="<?php echo $list[$i]['href'] ?>">
                        <h3><?php echo cut_str(strip_tags($list[$i]['subject']), 30)?> <?php
                    ...
                    //if (isset($list[$i]['icon_secret'])) echo $list[$i]['icon_secret'];
                     ?></h3>
                               ...
                               <div class="data_hit_wrap">
                                  <div class="row">
                                      <div class="col-md-8 col-sm-8 col-xs-8 date"><i class="far fa-calendar-check"></i> <?php echo $list[$i]['wr_datetime']; ?></div>
                                      <div class="col-md-4  col-sm-4 col-xs-4 hit"><i class="far fa-comment-dots"></i> <span><?php echo $list[$i]['wr_hit']; ?></span> </div>
                                   </div>
                               </div>
                     </div>
                            </div>
