                ...
                <div class="content_text">
                    ...
                    <div class="inst">
                      <ul class="list-inline">
                          ...
                          <li><span class="badge"><?php echo $list[$i]['wr_1'];?></span></li>
                          <?php } ?>
                          <?php if($list[$i]['wr_2']) { ?>
                          <li><strong>· 옵션2</strong></li>
                          <li><span class="badge"><?php echo $list[$i]['wr_2'];?></span></li>
                          <?php } ?>
                        </ul>
                    </div>
                    <?php } ?>
                    ...
                    <div class="btn_wrap">
                       <a href="<?php echo $list[$i]['href'] ?>" class="btn btn-pack "> 상세히 보기</a>
                        <a href="<?php echo G5_BBS_URL?>/write.php?bo_table=online" class="btn btn-pack blue "><strong><i class="fas fa-edit"></i> 문의하기</strong></a>
                    </div>
