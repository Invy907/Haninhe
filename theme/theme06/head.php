    ...
    <div class="swiper-wrapper">
            ...
            <div class="swiper-content">
                <div class="container">
                    <div class="content text-left">
                        <h1 class="animated" data-swiper-animation="fadeInUp" data-duration="1.8s" data-delay="2s"   data-swiper-out-animation="fadeIn" data-out-duration="1s" style="font-size:4.5em;color:#000;">재일본<br>도쿄<br>한인회</h1>
                        <p class="animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1.3s"  data-swiper-out-animation="fadeIn" data-out-duration="1s" style="color:#000;">THE TOKYO FEDERATION OF KOREAN<br>ASSOCIATIONS</p> 
        ...
        <div class="swiper-slide">
            <div class="swiper-content">
                <div class="container">
                    <div class="content text-left">
                        <h1 class="animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1s"   data-swiper-out-animation="fadeIn" data-out-duration="1s">재일본도쿄한국인연합회에<br><span>오신것을 환영합니다.</span></h1> 
                        ...
                        <p class="animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1.3s"  data-swiper-out-animation="fadeIn" data-out-duration="1s">THE TOKYO FEDERATION OF KOREAN<br>ASSOCIATIONS</p>
...
-            <div class="bg-dot  data-opacity"  data-opacity="0.3"></div>
        ...
        <div class="swiper-slide">
            <div class="swiper-content">
                <div class="container">
                    <div class="content text-left">
                        <h1 class="animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1s"   data-swiper-out-animation="fadeIn" data-out-duration="1s"><span style="color:#E81526;">THE TOKYO</span> FEDERATION <br>OF KOREAN ASSOCIATIONS</h1> 
                        <div class="line animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1.2s"  data-swiper-out-animation="fadeIn" data-out-duration="1s"></div>
                        <p class="animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1.3s"  data-swiper-out-animation="fadeIn" data-out-duration="1s">재일본도쿄한국인연합회에 오신것을 환영합니다.</p>
                        <div class="btn_wrap"><a href="<?=G5_URL?>/purpose"  class="btn btn-default animated" data-swiper-animation="fadeInUp" data-duration="1.2s" data-delay="1.5s"   data-swiper-out-animation="fadeIn" data-out-duration="2s">more</a></div>
                    </div>
                </div>
            </div>
