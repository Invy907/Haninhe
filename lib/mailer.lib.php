...
function mailer($fname, $fmail, $to, $subject, $content, $type=0, $file="", $cc="", $bcc="")
{
    ...
    try {
        ...
        if (defined('G5_SMTP') && G5_SMTP) {
            ...
            // MAIL CUSTOMER
    $mail->Host = "smtp.hetemail.jp"; // SMTP server
    $mail->Port = "465";        
    $mail->SMTPAuth = true;
    $mail->SMTPSecure = "ssl";
    $mail->Username = $fmail;
    $mail->Username = "no-reply@haninhe.com";
    $mail->Password = "Qwerty-123456";
    // MAIL CUSTOMER
  
        $mail->CharSet = 'UTF-8';
    $mail->From = "no-reply@haninhe.com";
    $mail->FromName = "haninhe";
