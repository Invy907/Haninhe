...
<!-- 회원가입결과 시작 { -->
<div id="reg_result" class="register" style="font-size:1.2em;">
    ...
    <p class="result_txt mt30 center" style="text-align:center;">
    ...
    <p class="result_txt mt30 t_center" style="text-align:center;">
...
<!-- } 회원가입결과 끝 -->
<div class="btn_confirm_reg mt50">
