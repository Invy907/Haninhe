	...
	<div id="register_form" class="form_01">   
	    <div class="register_form_inner">
	        ...
	        <ul>
	            <li>
	                ...
	                <div class="div_help2">영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</div>
	            </li>
	            <li class="half_input left_input margin_input">
	                ...
	                <?php if ($w=="u") { ?><div class="div_help2">비밀번호를 변경하실 경우 입력해 주세요.</div><?php } ?>
				</li>
	        ...
	        <ul>
	            ...
	            <li>
                    ...
                    <span id="msg_mb_nick"></span>
                    	<div class="div_help2">공백없이 한글,영문,숫자만 입력 가능 (한글2자, 영문4자 이상)</div>
	            </li>
	            <?php }  ?>
	            ...
	            <li>
	                ...
	                <input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" class="frm_input full_input" maxlength="20" placeholder="전화번호">
                    	<div class="div_help2">E-mail, 전화번호 중 하나는 반드시 입력해주세요.</div>
				</li>
	
	            <li>
	                <label for="reg_mb_homepage">생년월일</label>
	                <input type="date" name="mb_birth" value="<?php echo get_text(get_birth_format($member['mb_birth'])) ?>" required class="frm_input required" size="70" maxlength="255" placeholder="생년월일">
	            </li>
	            <li>
	                <label for="reg_mb_homepage">성별</label>
	                <input class="form-check-input" type="radio" name="mb_sex" id="exampleRadios1" value="M" <?php if ($member['mb_sex']!="F") echo "checked"; ?>> 남성　<input class="form-check-input" type="radio" name="mb_sex" id="exampleRadios2" value="F" <?php if ($member['mb_sex']=="F") echo "checked"; ?>> 여성
	            </li>
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        ...
	        <ul>
	            ...
	            <?php if ($config['cf_use_member_icon'] && $member['mb_level'] >= $config['cf_icon_level'] && false) {  ?>
	            <li>
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	            ...
	            <?php if ($member['mb_level'] >= $config['cf_icon_level'] && $config['cf_member_img_size'] && $config['cf_member_img_width'] && $config['cf_member_img_height'] && false) {  ?>
