...
<!-- 회원 비밀번호 확인 시작 { -->
<div id="mb_confirm" class="mbskin" style="background-color:#FFF;padding-top:5px;   box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;">
	<div style="padding:30px 0px;"><a href="<?=G5_URL?>"><img src="/_img/logo.jpg" style="width:250px;"></a></div>
    <p>
        <strong style="padding-bottom:10px;">비밀번호를 한번 더 입력해주세요.</strong>
