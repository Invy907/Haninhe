...
<div id="link1" class="index-content">
					...
					<div class="col-xs-6 col-md-3">
						...
						<div class="div_001">
							...
							<div class="div_004">
								...
								<?php if ($list[$i]['wr_1']) { ?>
								<div class="div_006">
									<div style="color:#2F3776;"><i class="fa fa-phone-square" aria-hidden="true"></i> <a href="tel:<?=$list[$i]['wr_1']?>" style="color:#2F3776;"><?=$list[$i]['wr_1']?></a></div>
								</div>
								<?php } ?>
								<?php if ($list[$i]['wr_4']) { ?>
								<div class="div_006" style="padding-top:0px;">
									<div style="color:#2F3776;"><i class="fa fa-home" aria-hidden="true"></i> <a href="<?=$list[$i]['wr_4']?>" target="_blank" style="color:#2F3776;"><?=$list[$i]['wr_4']?></a></div>
								</div>
								<?php } ?>
							</div>
						</div>
	...
	<div style="padding-top:10px;text-align:center;padding-top:20px;">
		<?php if ($list_href || $write_href) { ?>
			<?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_submit btn" title="Add NEWS" style="font-weight:normal;"><i class="fa fa-pencil-square" aria-hidden="true"></i> 기업/단체소개추가</a><?php } ?>
		<?php } ?>
	</div>
	<?php } ?>
