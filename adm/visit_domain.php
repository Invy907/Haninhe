...
<div class="tbl_head01 tbl_wrap">
    ...
    <thead>
    <tr>
        <th scope="col" style="font-size:1.0em;">순위</th>
        <th scope="col" style="font-size:1.0em;width:280px;">접속 도메인</th>
        <th scope="col" style="font-size:1.0em;">그래프</th>
        <th scope="col" style="font-size:1.0em;width:100px;">접속자수</th>
        <th scope="col" style="font-size:1.0em;width:90px;">비율(%)</th>
    </tr>
    </thead>
    <tfoot>
    <tr>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_num_c3" style="text-align:center;"><?php echo $count ?></td>
